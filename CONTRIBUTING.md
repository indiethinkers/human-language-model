# Contributing to Indie Thinkers
...
We are trying to build a body of work that leaves behind evidence of life.
...
Indie Thinkers is generally not the place for:

- Partisan commentary
- Culture-war debate
- Outrage-cycle writing
- Breaking-news takes
- Personal attacks
- Conspiracy claims
- Advocacy campaigns
- Submissions primarily designed to provoke, persuade, dunk, or litigate current controversies
- AI-generated slop, spam, SEO content, or content farms

To be clear, difficult subjects are not automatically out of scope.

The issue is usually the mode of writing, not merely the topic. A piece can take on something hard, painful, or unresolved and still belong here. But it needs reflection, care, originality, and durability.

We are interested in attention, not agitation.

We are interested in judgment, not performance.

## The Durability Test

Before submitting something, ask:

> Will this still be worth reading in one year if the news cycle has moved on?

If the answer is no, it probably is not a fit.

This does not mean every piece needs to be timeless or detached from the present. Some of the best writing is rooted in a specific moment. But it should not depend entirely on that moment for its value.

Yesterday's take is not today's archive.

## Contribution Workflow

Anyone may open an issue or pull request.

Maintainers review submissions for fit, quality, attribution, and alignment with the editorial charter. Only maintainers can merge.
...
GitHub can look strange if you have mostly lived in docs, email, blogs, or notebooks.

That is fine. You do not need to become a software engineer to contribute here. Think of GitHub as the workshop table where the files live, changes get proposed, and editorial conversations happen in public.

A few words help:

- A repository is the project folder.
- A fork is your own copy of that folder.
...
If you want to submit an essay, annotation, correction, or documentation change, you can:

1. Fork the repository.
2. Make your change in your fork.
3. Open a pull request back to this repository.
4. Use the submission format below so maintainers understand what you are proposing and why.

Do not worry if your first pull request is a little messy. Maintainers can help clean up formatting, metadata, links, and file placement. The important thing is that the idea is clear and the attribution is honest.

## Where Things Usually Live

You do not need to memorize the repo structure, but these are the common places:

- Essays live in `src/content/blog/`.
- Author information lives in `src/data/authors.ts`.
- Essay images and local media usually live in `src/assets/` or `public/media/`.
- Documentation lives at the root of the repository.
...
When opening an issue or pull request, this format helps:
...
You do not need to make the case in grand terms. Just make it clear.

## Attribution, Excerpts, and Rights
...
## Human-Written Work and AI Disclosure

Indie Thinkers is centered on human authorship, taste, judgment, and memory.

To be clear, we are not anti-AI. We are pro human-in-the-loop.

AI-assisted work must be disclosed. If a tool helped draft, revise, summarize, translate, structure, or otherwise shape the submission, say so plainly. Fully AI-generated submissions are generally not a fit.

The point is to preserve a corpus shaped by human judgment and authorship. A human language model needs humans in it.

## Editorial Decisions

Maintainers reserve final editorial discretion over what appears in the archive, website, newsletter, repository, and related channels.

Rejections are not necessarily judgments on the writer, the source, or the importance of the subject. Some work may need more time, better framing, clearer attribution, or a different venue. Some work may simply not belong here.

Indie Thinkers can be open to contribution without being obligated to publish every contribution.

That tension is part of the project.

## Editorial Collaboration

Accepted work may still be edited.

Maintainers may suggest changes to framing, title, deck, metadata, excerpts, links, formatting, images, or presentation. Sometimes a piece is close, but not quite there yet. Sometimes the idea is strong and the shape needs work.
...
Please help keep discussion useful and humane.

- Be generous.
- Assume good faith.
- Critique ideas, not people.
- Do not harass, threaten, spam, or derail.
- Do not use submissions or discussions to wage ideological battles.
- Respect maintainers' editorial decisions.

Strong opinions are welcome when they are carried with care, specificity, and respect for the project. Derailment is not.
